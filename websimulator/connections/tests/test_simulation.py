...
class SimulationTestCase(TestCase):
    ...
    def setUp(self):
        self.message_correct = {'values': {'tree': {'nodes': {
            '05d86396-986a-42bd-b1b9-5c47e1d94e62': {'parameters': {}, 'name': 'GoToPos', 'description': '',
                                                     'properties': {'xGoal': 1, 'yGoal': 1},
                                                     'display': {'x': 288, 'y': 0}, 'title': 'GoToPos_A',
                                                     'id': '05d86396-986a-42bd-b1b9-5c47e1d94e62'}},
                                                    'root': '05d86396-986a-42bd-b1b9-5c47e1d94e62'}},
                                'type': 'simulate', 'channel_name': 'specific.ONGYcQVC!RIeWJnGgWjUC'}
        self.message_incorrect = {'values': {'tree': {'nodes': {
            '05d86396-986a-42bd-b1b9-5c47e1d94e62': {'parameters': {}, 'name': 'GoToPos', 'description': '',
                                                     'properties': {'xGoal': 1, 'yGoal': 1},
                                                     'display': {'x': 288, 'y': 0}, 'title': 'GoToPos',
                                                     'id': '05d86396-986a-42bd-b1b9-5c47e1d94e62'}},
                                                      'root': '05d86396-986a-42bd-b1b9-5c47e1d94e62'}},
                                  'type': 'simulate', 'channel_name': 'specific.ONGYcQVC!RIeWJnGgWjUC'}
